...
#    python ERA5_downloader_daily_example.py --output_dir /Volumes/easystore/ERA5_single_level_2mTemp/ --variables 2m_temperature --start_year 1961 --end_year 1990 --months 01 02

#    where --outputdir is destination to download the data, --variable is ERA5 climate variables of interest and can be single or multiple, by default it downloads 1-12 month for each year
...
def download_year(year, client, output_dir, variables,months, days, hours, daily_statistics):
    ...
    try:
        ...
        client.retrieve(
            'derived-era5-single-levels-daily-statistics',   # optional 'reanalysis-era5-land-monthly-means' 'derived-era5-land-daily-statistics'
            {
