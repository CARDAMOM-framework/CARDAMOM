...
MORTALITY=mean(sum(CBR.FLUXES(:,:,[F.fx_lab2lit,F.fx_fol2lit,F.fx_roo2lit,F.fx_woo2cwd]),3));
...
V=GPP;U=GPPunc;
subplot(3,3,1);plot(V);hold on;plot(V+U,'--');plot(V-U,'--');

V=Rauto;U=Rautounc;
subplot(3,3,2);plot(V);hold on;plot(V+U,'--');plot(V-U,'--');

V=Rhet;U=Rhetunc;
subplot(3,3,3);plot(V);hold on;plot(V+U,'--');plot(V-U,'--');

V=Fire;U=Fireunc;
subplot(3,3,4);plot(V);hold on;plot(V+U,'--');plot(V-U,'--');


V=DefDeg;U=DefDegunc;
subplot(3,3,5);plot(V);hold on;plot(V+U,'--');plot(V-U,'--');

V=MORTALITY;U=MORTALITYunc;
subplot(3,3,6);plot(V);hold on;plot(V+U,'--');plot(V-U,'--');

V=ABGB;U=ABGBunc;
subplot(3,3,7);plot(V);hold on;plot(V+U,'--');plot(V-U,'--');

V=DOM;U=DOMunc;
subplot(3,3,8);plot(V);hold on;plot(V+U,'--');plot(V-U,'--');
