...
%Step 3. Adapth the paths to make sure these are consistent with your directory system (e.g. depending on where you placed the "CARDAMOM" folder).  We recommend using absolute paths, in case the CARDAMOM folder is not in the current matlab directory, for example “/Users/Yourusername/CARDAMOM_2.1.6c/C”
%*****CARDAMOM C PATH******
