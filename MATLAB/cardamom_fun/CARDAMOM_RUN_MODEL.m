...
%LAI
  ...
  if size(CBR.POOLS,3)>6
      if OPT.MODEL.ID<=8 | any(ismember([801,802,803,804,805,806,807,808,809,810,811,812,813,10,1000,1001,1002,1003,1005,1009,1015],OPT.MODEL.ID))
...
if any(ismember([809,811,812,813,1000,1001,1002,1003,1005,1009,1010,1011,1015,1030,1031,1032],OPT.MODEL.ID))
