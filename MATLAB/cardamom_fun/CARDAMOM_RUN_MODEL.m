...
%LAI
  ...
  if size(CBR.POOLS,3)>6
      if OPT.MODEL.ID<=8 | OPT.MODEL.ID==801 | OPT.MODEL.ID==802 | OPT.MODEL.ID==803  | OPT.MODEL.ID==804  | OPT.MODEL.ID==805   | OPT.MODEL.ID==806   | OPT.MODEL.ID==807   | OPT.MODEL.ID==808    | OPT.MODEL.ID==809 | OPT.MODEL.ID==810 | OPT.MODEL.ID==811 | OPT.MODEL.ID==812 | OPT.MODEL.ID==813 | OPT.MODEL.ID==10  | OPT.MODEL.ID==1000
...
if OPT.MODEL.ID==811 ||  OPT.MODEL.ID==809 || OPT.MODEL.ID==1000 || OPT.MODEL.ID==812 || OPT.MODEL.ID==813;
