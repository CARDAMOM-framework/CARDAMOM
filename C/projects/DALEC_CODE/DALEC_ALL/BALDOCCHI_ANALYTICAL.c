...
double* BALDOCCHI_ANALYTICAL(double const *met_list, double const *var_list)
{
    ...
    APAR=(double)met_list[3]*(1-exp(-var_list[6]*var_list[5]))*1e6/0.327/86400.; /*trailing constants here ensure translation from MJ m^-2 d^-1 to umol m^-2 s^-1, which is required for our analytical setup*/
    a=(double)0.7;
