...
if (O->SUPPORT_SIF_OBS){   ML[LI.SIF]=CARDAMOM_TIMESERIES_OBS_LIKELIHOOD(&D.ncdf_data.SIF, D.M_GPP);
//printf("in SIF TS OBS LIKELIHOOD\n");
}; // shuang
...
//        printf("in iniSOM single OBS LIKELIHOOD\n");
};
