...
MCOPT.APPEND=0;
MCOPT.nADAPT=20;/*was 20*/
MCOPT.fADAPT=0.5;
MCOPT.nOUT=2000;/*was 2000*/
MCOPT.nPRINT=0;
MCOPT.nWRITE=0;
/*randparini = 0*/
...
MCOPT.fixedpars=1;
MCOPT.mcmcid=1;/*Using metropolis-hastings to find initial parameters*/
...
fclose(fileout0);}
/*Otherwise sampling new parameters*/
else{
/*done*/
...
while (PEDC!=0){
	...
	MHMCMC(EMLF,CARDADATA,*PI,MCOPT,&MCOUT);
