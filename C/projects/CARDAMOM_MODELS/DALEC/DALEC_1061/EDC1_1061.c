#pragma once
int EDC1_1061(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{
...
4. Root turnover greater than SOM turnover at meantemp5. Allocation to canopy is comparable to allocation to fine roots
