...
/*DALEC 1013 remove edc for paw_fs, based on 1011, 1012 is created only for main branch, 1012 updated ET equation in 1011*/

int DALEC_1013(DATA DATA, double const *pars)
{
