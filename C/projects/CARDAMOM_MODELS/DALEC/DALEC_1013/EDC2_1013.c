...
int EDC2_1013(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{
...
/*EDC JointC: PAW < PAW_fs  jc  1013 delete this criteria*/
// if (((EDC==1 & DIAG==0) || DIAG==1 || (EDC==1 & DIAG==2 & EDCD->SWITCH[18-1]==1)) & (pars[36]<(POOLS[6]*1))){EDC=ipow(0,EDCD->SWITCH[18-1]);EDCD->PASSFAIL[18-1]=0;}
