...
//if  (SOBS.value!=DEFAULT_DOUBLE_VAL){D->M_PEQ_CUE=D->M_PARS[O->CUE_PARAM];} //P21
if  (SOBS.value!=DEFAULT_DOUBLE_VAL){(1-D->M_PEQ_CUE)=D->M_PARS[O->CUE_PARAM];} //P22
