#pragma once
double * LIU_An_et(double SRAD, double VPD, double TEMP, double vcmax25, double co2, double beta_factor, double g1, double LAI, double ga, double VegK, double clapp_theta){
...
double VPD_kPa = VPD*100.0; //100.0 kPa = 1000.0 hPa => Surface pressure
...
r[1] = transp*24.*60.*60./10.; //from mm.s-1 to mm.day-1

evap = petVnumB*(0.28/clapp_theta);
