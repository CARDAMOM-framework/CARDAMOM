...
#include "../../../CARDAMOM_MODELS/DALEC/DALEC_1051/LIU_An_et.c"

/*Code used by Bloom et al., 2016
See also Bloom & Williams 2015,  Fox et al., 2009; Williams et al., 1997*/

int DALEC_1051(DATA DATA, double const *pars)
{
...
gpppars[7]=DATA.MET[m+3];//Shortwave downward radiation
...
double leaf_refl = pars[44]; 


//FLUXES[f+0]=LIU_An(gpppars,constants,pars,beta)*beta;
//FLUXES[f+0]=LIU_An(SRAD, VPD, TEMP, vcmax25, co2, beta, g1)*beta;
FLUXES[f+0]=LIU_An_et(SRAD, VPD, TEMP, vcmax25, co2, beta, g1, LAI[n], ga, VegK, Tupp, Tdown, C3_frac, CI, leaf_refl)[0];

//transpiration//
FLUXES[f+32] = LIU_An_et(SRAD, VPD, TEMP, vcmax25, co2, beta, g1, LAI[n], ga, VegK, Tupp, Tdown, C3_frac, CI, leaf_refl)[1];
//evaporation//
FLUXES[f+33] = LIU_An_et(SRAD, VPD, TEMP, vcmax25, co2, beta, g1, LAI[n], ga, VegK, Tupp, Tdown, C3_frac, CI, leaf_refl)[2];
