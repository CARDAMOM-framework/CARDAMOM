...
#include "DALEC_1108_INDICES.c"
#include "PARS_INFO_1108.c"
...
int DALEC_1108_FLUX_SOURCES_SINKS(DALEC * DALECmodel){
...
int DALEC_1108(DATA DATA, double const *pars){
...
int DALEC_1108_MODCONFIG(DALEC * DALECmodel, DATA * DATA){


struct DALEC_1108_PARAMETERS P=DALEC_1108_PARAMETERS;
struct DALEC_1108_FLUXES F=DALEC_1108_FLUXES;
struct DALEC_1108_POOLS S=DALEC_1108_POOLS;
struct DALEC_1108_EDCs E=DALEC_1108_EDCs;




DALECmodel->dalec=DALEC_1108;
...
DALEC_1108_FLUX_SOURCES_SINKS(DALECmodel);




//Define PARS_INFO here (ranges, and eventually names, etc)
PARS_INFO_1108(DALECmodel);
