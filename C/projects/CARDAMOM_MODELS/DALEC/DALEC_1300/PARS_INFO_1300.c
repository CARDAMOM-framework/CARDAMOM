...
int PARS_INFO_1300(DALEC * DALECmodel){
...
/*Living tissue C:N ratio*/
parmin[P.mineralization_factor]=20.;
parmax[P.mineralization_factor]=75.;

/*Mineralization factor of Nitrogen*/
parmin[P.mineralization_factor]=0.02;
parmax[P.mineralization_factor]=0.05;

/*Cost parameter of AM uptake relative to N */
parmin[P.am_cost_par_n]=0.001;
parmax[P.am_cost_par_n]=1.2;

/*Cost parameter of AM uptake relative to C */
parmin[P.am_cost_par_c]=0.001;
parmax[P.am_cost_par_c]=1.2;

/*Cost parameter of ECM uptake relative to N */
parmin[P.ecm_cost_par_n]=0.001;
parmax[P.ecm_cost_par_n]=1.2;

/*Cost parameter of ECM uptake relative to C */
parmin[P.ecm_cost_par_c]=0.001;
parmax[P.ecm_cost_par_c]=1.2;
