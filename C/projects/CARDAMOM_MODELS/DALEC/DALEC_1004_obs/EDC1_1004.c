#pragma once
double EDC1_1004(double const *pars, DATA DATA)
{
...
/*Counting EDCs dynamically to allow for multi-module EDC issue*/
/*Storing outputs in DATA.M_EDCD*/
/*Introduce "DATA.edccount" which is set to zero for every model run*/
/*Diagnostic flags etc. can be used in final "P" calculation*/
/*Function now returns probability P*/
