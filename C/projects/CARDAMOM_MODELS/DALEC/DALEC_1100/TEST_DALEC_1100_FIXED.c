...
// Include only minimal CARDAMOM dependencies (not the full framework)
...
// Forward declare DALEC struct to resolve circular dependency
typedef struct DALEC DALEC;

// Include DALEC_1100 (which includes DALEC_MODULE with full DALEC struct definition)
