...
/*Initial LAI*/
CARDADATA->parmin[36]=1.0;
CARDADATA->parmax[36]=5.0;

/*Mean temperature at leaf onset (T_phi)*/
CARDADATA->parmin[37]=12.0;
CARDADATA->parmax[37]=30.0;
