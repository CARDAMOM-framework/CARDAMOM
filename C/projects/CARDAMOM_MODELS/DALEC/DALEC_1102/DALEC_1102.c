...
int DALEC_1102_MODCONFIG(DALEC * DALECmodel){


struct DALEC_1102_PARAMETERS P=DALEC_1102_PARAMETERS;
struct DALEC_1102_FLUXES F=DALEC_1102_FLUXES;
struct DALEC_1102_POOLS S=DALEC_1102_POOLS;
...
int DALEC_1102(DATA DATA, double const *pars){
