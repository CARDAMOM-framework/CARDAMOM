...
#include "DALEC_1130_INDICES.c"
#include "PARS_INFO_1130.c"
...
typedef struct DALEC_1130_DATA_STRUCT{
double * VegK;
double example_const;
}DALEC_1130_DATA_STRUCT;


int PREDERIVE_DALEC_1130_DATA(DALEC * DALECmodel, DATA * DATA){

    //Step 1. Define function here
static DALEC_1130_DATA_STRUCT DALEC_1130_DATA;
...
//Store data in  DALEC_1130_DATA
    DALEC_1130_DATA.VegK=VegK;


    //Store for later use
    DALECmodel->MODEL_DATA=&DALEC_1130_DATA;
...
int DALEC_1130_FLUX_SOURCES_SINKS(DALEC * DALECmodel){
    

    struct DALEC_1130_FLUXES F=DALEC_1130_FLUXES;
    struct DALEC_1130_POOLS S=DALEC_1130_POOLS;
...
int DALEC_1130(DATA DATA, double const *pars){

    



struct DALEC_1130_PARAMETERS P=DALEC_1130_PARAMETERS;
struct DALEC_1130_FLUXES F=DALEC_1130_FLUXES;
struct DALEC_1130_POOLS S=DALEC_1130_POOLS;
...
//   }ALLOC_AND_AUTO_RESP_FLUXES_STRUCT;
   ...
   //Declare
    ...
    ARFLUXES.IN.k_growth=pars[P.k];
    ARFLUXES.IN.W_o=pars[P.W_o];
    ARFLUXES.IN.s_ar=pars[P.s_ar];
    ARFLUXES.IN.s_wood=pars[P.s_wood];
    ARFLUXES.IN.s_root=pars[P.s_root];
    ARFLUXES.IN.e_ar=pars[P.e_ar];
    ARFLUXES.IN.e_wood=pars[P.e_wood];
    ARFLUXES.IN.e_root=pars[P.e_root];
...
DALEC_1130_DATA_STRUCT * DALEC_1130_DATA=(DALEC_1130_DATA_STRUCT *)DALECmodel->MODEL_DATA;
    
    double VegK=DALEC_1130_DATA->VegK[n];
//CONTINUE FROM HERE(
    //printf("VegK internal, external = %2.2f,  %2.2f\n",VegK, DALEC_1130_DATA->VegK[n]);
...
int DALEC_1130_MODCONFIG(DALEC * DALECmodel, DATA * DATA){


    PREDERIVE_DALEC_1130_DATA(DALECmodel, DATA);

struct DALEC_1130_PARAMETERS P=DALEC_1130_PARAMETERS;
struct DALEC_1130_FLUXES F=DALEC_1130_FLUXES;
struct DALEC_1130_POOLS S=DALEC_1130_POOLS;
struct DALEC_1130_EDCs E=DALEC_1130_EDCs;




 //DALECmodel->data=DALEC_1130_DATA;
DALECmodel->dalec=DALEC_1130;
