...
int PARS_INFO_902(DATA *CARDADATA)
{
...
// Min VPD for GSI - in hPa
CARDADATA->parmin[24]=0.01;//1.;
CARDADATA->parmax[24]=55.;//5500.;

// Max VPD for GSI - in hPa
CARDADATA->parmin[25]=0.01;//1.;
CARDADATA->parmax[25]=55.;//5500.;
