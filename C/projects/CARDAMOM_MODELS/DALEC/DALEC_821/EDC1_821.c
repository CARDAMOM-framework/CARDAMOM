#pragma once
int EDC1_821(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{
...
double const flab=(1-fauto-ffol)*pars[11];
...
if (((EDC==1 & DIAG==0) || DIAG==1 || (EDC==1 & DIAG==2 & EDCD->SWITCH[4-1]==1)) & (pars[6]<pars[8])){EDC=0;EDCD->PASSFAIL[4-1]=0;}
...
if (((EDC==1 & DIAG==0) || DIAG==1 || (EDC==1 & DIAG==2 & EDCD->SWITCH[15-1]==1)) & (pars[25]<pars[26] | pars[25]<pars[27])){EDC=0;EDCD->PASSFAIL[15-1]=0;}
