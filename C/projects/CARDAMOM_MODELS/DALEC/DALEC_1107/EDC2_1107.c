...
int EDC2_1107(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{

struct DALEC_1107_PARAMETERS P=DALEC_1107_PARAMETERS;
struct DALEC_1107_FLUXES F=DALEC_1107_FLUXES;
struct DALEC_1107_POOLS S=DALEC_1107_POOLS;
...
int noprogpools=10;//Prognostic pools only for EDCs
...
Fout[S.C_lab]=FT[F.foliar_prod]+FT[F.root_prod]+ FT[F.wood_prod]+FT[F.f_lab]+FT[F.fx_lab2lit];
/*foliar*/
Fin[S.C_fol]=FT[F.foliar_prod];
Fout[S.C_fol]=FT[F.fol2lit]+FT[F.f_fol]+FT[F.fx_fol2lit];
/*root*/
Fin[S.C_roo]=FT[F.root_prod];
Fout[S.C_roo]=FT[F.roo2lit]+FT[F.f_roo]+FT[F.fx_roo2lit];
/*wood*/
Fin[S.C_woo]=FT[F.wood_prod];
Fout[S.C_woo]=FT[F.woo2cwd]+FT[F.f_woo]+FT[F.fx_woo2cwd];
/*CWD*/
Fin[S.C_cwd]=FT[F.woo2cwd]+FT[F.fx_woo2cwd];
Fout[S.C_cwd]=FT[F.ae_rh_cwd]+FT[F.an_rh_cwd]+FT[F.cwd2som]+FT[F.f_cwd]+FT[F.fx_cwd2som];
/*litter*/
Fin[S.C_lit]=FT[F.fol2lit]+FT[F.roo2lit]+FT[F.fx_lab2lit]+FT[F.fx_fol2lit]+FT[F.fx_roo2lit];
...
/*Ensuring that wilting point is at or below the mean H2O pool EDC14 (No longer applicable)*/ 
