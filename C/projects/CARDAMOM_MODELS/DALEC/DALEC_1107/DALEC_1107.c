...
#include "DALEC_1107_INDICES.c"
#include "PARS_INFO_1107.c"
...
int DALEC_1107_FLUX_SOURCES_SINKS(DALEC * DALECmodel){
...
int DALEC_1107(DATA DATA, double const *pars){
...
int DALEC_1107_MODCONFIG(DALEC * DALECmodel, DATA * DATA){


struct DALEC_1107_PARAMETERS P=DALEC_1107_PARAMETERS;
struct DALEC_1107_FLUXES F=DALEC_1107_FLUXES;
struct DALEC_1107_POOLS S=DALEC_1107_POOLS;
struct DALEC_1107_EDCs E=DALEC_1107_EDCs;




DALECmodel->dalec=DALEC_1107;
...
DALEC_1107_FLUX_SOURCES_SINKS(DALECmodel);




//Define PARS_INFO here (ranges, and eventually names, etc)
PARS_INFO_1107(DALECmodel);
