...
int EDC2_810(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{
...
EDCD->pEDC=EDCD->pEDC-0.5*pow(log(MPOOLS[1]/MPOOLS[2])/log(2),2);
...
*/
/***********************EDCs done here****************************/
EDCD->pEDC=EDCD->pEDC+log(1/(1+exp(10*(pars[25]-MPOOLS[6])/MPOOLS[6])));
