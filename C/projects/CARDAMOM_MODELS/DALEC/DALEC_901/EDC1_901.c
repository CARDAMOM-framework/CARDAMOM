#pragma once
int EDC1_901(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{
...
if (((EDC==1 & DIAG==0) || DIAG==1 || (EDC==1 & DIAG==2 & EDCD->SWITCH[15-1]==1)) & (pars[24]<pars[25] | pars[24]<pars[26])){EDC=0;EDCD->PASSFAIL[15-1]=0;}
