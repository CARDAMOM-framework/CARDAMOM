...
#include "../CARDAMOM_MODELS/DALEC/DALEC_900/MODEL_INFO_900.c"
#include "../CARDAMOM_MODELS/DALEC/DALEC_901/MODEL_INFO_901.c"
#include "../CARDAMOM_MODELS/DALEC/DALEC_902/MODEL_INFO_902.c"
...
else if (DATA->ID==900  ){MODEL_INFO_900(DATA);}
else if (DATA->ID==901  ){MODEL_INFO_901(DATA);}
else if (DATA->ID==902  ){MODEL_INFO_902(DATA);}
