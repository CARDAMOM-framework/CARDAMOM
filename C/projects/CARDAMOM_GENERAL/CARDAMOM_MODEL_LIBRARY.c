...
//#include "../CARDAMOM_MODELS/DALEC/DALEC_1040/MODEL_INFO_1040.c"
		...
		#include "../CARDAMOM_MODELS/DALEC/DALEC_1045/MODEL_INFO_1045.c"
		#include "../CARDAMOM_MODELS/DALEC/DALEC_1046/MODEL_INFO_1046.c"
		#include "../CARDAMOM_MODELS/DALEC/DALEC_1047/MODEL_INFO_1047.c"
...
#include "../CARDAMOM_MODELS/DALEC/DALEC_1110/MODEL_INFO_1110.c"
#include "../CARDAMOM_MODELS/DALEC/DALEC_1111/MODEL_INFO_1111.c"  // DALEC-PyC
    ...
    // #include "../CARDAMOM_MODELS/DALEC/DALEC_1107/MODEL_INFO_1107.c"
    // #include "../CARDAMOM_MODELS/DALEC/DALEC_1108/MODEL_INFO_1108.c"
    // #include "../CARDAMOM_MODELS/DALEC/DALEC_1109/MODEL_INFO_1109.c"
    // #include "../CARDAMOM_MODELS/DALEC/DALEC_1130/MODEL_INFO_1130.c"
...
else if (ID==1045  ){MODEL_INFO_1045(DATA);}
else if (ID==1046  ){MODEL_INFO_1046(DATA);}
else if (ID==1047  ){MODEL_INFO_1047(DATA);}
...
//else if (ID==1200  ){MODEL_INFO_1200(DATA);}
        ...
        else if (ID==1110  ){MODEL_INFO_1110(DATA);}
        else if (ID==1111  ){MODEL_INFO_1111(DATA);}  // DALEC-PyC: NISAR fire carbon + pyrogenic C pools
    ...
    //else if (ID==1105  ){MODEL_INFO_1105(DATA);}
        ...
        // else if (ID==1107  ){MODEL_INFO_1107(DATA);}
        // else if (ID==1108  ){MODEL_INFO_1108(DATA);}
        // else if (ID==1109  ){MODEL_INFO_1109(DATA);}
        // else if (ID==1130  ){MODEL_INFO_1130(DATA);}
        else {status=1;
        printf("*********************************************\n");
