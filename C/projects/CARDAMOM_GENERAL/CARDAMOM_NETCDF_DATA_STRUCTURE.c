...
TIMESERIES_OBS_STRUCT PEQ_rhch4_rhco2;
//SINGLE_OBS_STRUCT PEQ_rhco2_rh;
/*SINGLE_OBS_STRUCT PEQ_thetas_opt;
SINGLE_OBS_STRUCT PEQ_fwc;
SINGLE_OBS_STRUCT PEQ_Q10ch4;
SINGLE_OBS_STRUCT PEQ_Q10rhco2;
SINGLE_OBS_STRUCT PEQ_retention;*/
/* SINGLE_OBS_STRUCT PEQ_Med_g1;
SINGLE_OBS_STRUCT PEQ_Vcmax25;
SINGLE_OBS_STRUCT PEQ_ga;
SINGLE_OBS_STRUCT PEQ_Tdown; */
    // end of pMCMC
