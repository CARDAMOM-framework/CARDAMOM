...
TIMESERIES_OBS_STRUCT LE;
TIMESERIES_OBS_STRUCT H;
TIMESERIES_OBS_STRUCT EWT;
TIMESERIES_OBS_STRUCT FIR;
...
TIMESERIES_OBS_STRUCT SWE; 
TIMESERIES_OBS_STRUCT NISAR_WOOD; // NISAR L-band woody fire structural loss
...
SINGLE_OBS_STRUCT PEQ_r_ch4;
SINGLE_OBS_STRUCT PEQ_S_fv;
SINGLE_OBS_STRUCT PEQ_rhch4_rhco2;

//Drivers

TIMESERIES_DRIVER_STRUCT BURNED_AREA;
TIMESERIES_DRIVER_STRUCT CO2;
TIMESERIES_DRIVER_STRUCT DISTURBANCE_FLUX;
...
TIMESERIES_DRIVER_STRUCT FRP; // VIIRS fire radiative power (MW km-2), for combustion efficiency
