...
DATA->LE=READ_NETCDF_TIMESERIES_OBS_FIELDS(ncid, "LE");
DATA->H=READ_NETCDF_TIMESERIES_OBS_FIELDS(ncid, "H");
...
DATA->SWE=READ_NETCDF_TIMESERIES_OBS_FIELDS(ncid, "SWE");
...
printf("Preprocess LE: ");
TIMESERIES_OBS_STRUCT_PREPROCESS(&DATA->LE);
printf("Preprocess H: ");
TIMESERIES_OBS_STRUCT_PREPROCESS(&DATA->H);
...
printf("Preprocess SWE: ");
TIMESERIES_OBS_STRUCT_PREPROCESS(&DATA->SWE);
