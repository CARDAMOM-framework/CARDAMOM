...
int STEP_WITH_BOUNCE_112(double *pars0, double *pars, PARAMETER_INFO PI,double amp,  MCMC_OPTIONS MCO){
...
for (n=0;n<PI.npars;n++){
	...
	/*normalizing parameter*/
		rn=randn();rn2=randn();
		step = rn*PI.stepsize[n]*(1-PI.parfix[n])*amp + rn2*MCO.minstepsize;
