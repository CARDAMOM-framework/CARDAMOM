...
int STEP_WITH_BOUNCE_113(double *pars0, double *pars, PARAMETER_INFO PI,COUNTERS N,  MCMC_OPTIONS MCO){

/*FIXEDPARS*/
/*ones and zeros depending on whether parameters are kept fixed*/

int n,fp;
double npar,rn,step, npar_new, rn2;
...
for (n=0;n<PI.npars;n++){
	...
	/*normalizing parameter*/
		rn=randn();rn2=randn();
		step = rn*N.parstdev[n]*(1-PI.parfix[n])*N.amp + rn2*MCO.minstepsize;
