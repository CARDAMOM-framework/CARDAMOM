...
#include "NORMPARS.c"
#include "ADAPT_STEP_SIZE_112.c"
#include "STEP.c"
#include "STEP_WITH_BOUNCE_112.c"
...
while (N.ACC < MCO.nOUT && (P<0 || MCO.nWRITE>0 || N.ACC==0)){
	/*take a step*/
	STEP_WITH_BOUNCE_112(PARS0,PARS,PI,amp,MCO);
	...
	if (N.ITER % MCO.nADAPT==0){
		...
		ADAPT_STEP_SIZE_112(PARSALL,PI,N,MCO,&amp);}
