...
2. Net carbon assimilation is calculated based on C3 photosynthesis biochemistry to determine potential leaf-level photosynthesis (unstressed by water availability). This is expressed in terms of two potentially limiting rates:
...
3. The total net carbon assimilation (:math:`A_n`) is
