...
.. list-table:: Prognostic variables (pools)
   ...
   * - :math:`W_{ly1}`
     ...
     - mmH\ :sub:`2`\ O
     - :math:`Qx_{inf}`
     - :math:`Ev`, :math:`Tr_{ly1}`, :math:`Q_{ly1}`, :math:`Qx_{ly12}`
     - ``H2O_LY1``
     - 
   * - :math:`W_{ly2}`
     - Layer 2 water
     - mmH\ :sub:`2`\ O
     - :math:`Qx_{ly12}`
     - :math:`Tr_{ly2}`, :math:`Q_{ly2}`, :math:`Qx_{ly23}`
     - ``H2O_LY2``
     - 
   * - :math:`W_{ly3}`
     - Layer 3 water
   ...
   * - :math:`E_{ly1}`
     ...
     - :math:`EEv`, :math:`ETr_{ly1}`, :math:`EQ_{ly1}`, :math:`EQx_{ly12}`, :math:`EQthx_{ly12}`
     - ``E_LY1``
     - 
   * - :math:`E_{ly2}`
     - Energy content of :math:`W_{ly2}`
     - J m\ :sup:`-2`
     - :math:`EQx_{ly12}`, :math:`EQthx_{ly12}`
     - :math:`ETr_{ly2}`, :math:`EQ_{ly2}`, :math:`EQx_{ly23}`, :math:`EQthx_{ly23}`
     - ``E_LY2``
     - 
   * - :math:`E_{ly3}`
     - Energy content of :math:`W_{ly3}`
     - J m\ :sup:`-2`
     - :math:`E_{geo}`, :math:`EQx_{ly23}`, :math:`EQthx_{ly23}`
     - :math:`EQ_{ly3}`
     - ``E_LY3``
     - 
...
.. list-table:: Fluxes
   ...
   * - :math:`EQx_{ly12}`
     - Internal energy of :math:`Qx_{ly12}`
     - J m\ :sup:`-2` d\ :sup:`-1`
     - ``ly1xly2_e``
     - Based on temperature of donor pool (:math:`W_{ly1}` when :math:`Qx_{ly12}` is positive, :math:`W_{ly2}` when :math:`Qx_{ly12}` is negative)
   * - :math:`EQx_{ly23}`
     - Internal energy of :math:`Qx_{ly23}`
     - J m\ :sup:`-2` d\ :sup:`-1`
     - ``ly2xly3_e``
     - Based on temperature of donor pool (:math:`W_{ly2}` when :math:`Qx_{ly23}` is positive, :math:`W_{ly3}` when :math:`Qx_{ly23}` is negative)
   * - :math:`EQthx_{ly12}`
