#pragma once
int EDC1_808(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{
...
/*Band checks here*/
/*if (((EDC==1 & DIAG==0) || DIAG==1 || (EDC==1 & DIAG==2 & EDCD->SWITCH[16-1]==1)) & (pars[33]>pars[34])){EDC=0;EDCD->PASSFAIL[16-1]=0;}*/
...
/*PARS[33 - 39]*/
/*Pband (band 1)*/
double Pband_h2o_rz=pars[33];
double Pband_h2o_ns=(1 - Pband_h2o_rz)*pars[34];
double Pband_woo=1-Pband_h2o_rz-Pband_h2o_ns;
/*Lband (band 2)*/
double Lband_h2o_rz=pars[35];
double Lband_h2o_ns=(1 - Lband_h2o_rz)*pars[36];
double Lband_woo=(1-Lband_h2o_rz-Lband_h2o_ns)*pars[37];
double Lband_fol=1- Lband_h2o_rz - Lband_h2o_ns - Lband_woo;
/*Cband (band 3)*/
double Cband_h2o_ns=pars[38];
double Cband_woo=(1-Cband_h2o_ns)*pars[39];
double Cband_fol=1-Cband_woo - Cband_h2o_ns;
/*Kuband (band 4)*/
double Kuband_fol=pars[40];
...
if ((EDC==1 & DIAG==0) || DIAG==1 || (EDC==1 & DIAG==2 & EDCD->SWITCH[16-1]==1)){

if (Pband_h2o_ns/Pband_h2o_rz>Lband_h2o_ns/Lband_h2o_rz){allbandpass=0;}
if (Pband_h2o_ns/Pband_woo>Lband_h2o_ns/Lband_woo){allbandpass=0;}
if (Lband_h2o_ns/Lband_woo>Cband_h2o_ns/Cband_woo){allbandpass=0;}
if (Lband_fol/Lband_woo>Cband_fol/Cband_woo){allbandpass=0;}

/*
if (Pband_h2o_rz<Lband_h2o_rz){allbandpass=0;}
if (Pband_h2o_ns>Lband_h2o_ns){allbandpass=0;}
if (Pband_woo<Lband_woo){allbandpass=0;}
if (Lband_woo<Cband_woo){allbandpass=0;}
if (Lband_h2o_ns>Cband_h2o_ns){allbandpass=0;}
if (Lband_fol>Cband_fol){allbandpass=0;}
if (Kuband_fol<Cband_fol){allbandpass=0;}
*/


if (allbandpass==0){EDC=0;EDCD->PASSFAIL[16-1]=0;}
}
