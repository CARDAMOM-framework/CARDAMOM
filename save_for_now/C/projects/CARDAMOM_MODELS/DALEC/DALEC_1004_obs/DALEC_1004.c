...
#include "INFILTRATION.c";
/*Code used by Bloom et al., 2016
See also Bloom & Williams 2015,  Fox et al., 2009; Williams et al., 1997*/
/*NOTES*/
/*Each *MODULE* can have the same size type*/
/*Using "union" we can call fields by name or by index*/
/*All pointers can be initialized as NULL*/
/*Mounted volumes will be accessed to back out parmin, parmax, npars*/
...
/*Declare & mount sub-modules*/
MOUNT_INFILTRATION_MODULE(DATA);
...
int DALEC_1004(DATA DATA, double const *pars_global)
{

/*extract parameters from DALEC modules*/
double const *pars=&pars_global[DATA.MODULE_IDX.MODELS.dalec_1004];
...
/*New feature: DALEC can populate its own DATA.M_P[0] value.*/
/*EDCs can therefore be internally calculated with little (if any) external definitions necessary*/
/*This will be accompanied by a new MLF function to support reduced external EDC representation*/


/*Calculate EDC1 probability here
...DATA.M_P[0] will mediate probability 
...*/
EDC1_1004(pars, DATA);
