#pragma once
int EDC1_1010(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{
...
if (((EDC==1 & DIAG==0) || DIAG==1 || (EDC==1 & DIAG==2 & EDCD->SWITCH[4-1]==1)) & (pars[6]<pars[8]*pow(pars[9],meantemp/10))){EDC=0;EDCD->PASSFAIL[4-1]=0;}
