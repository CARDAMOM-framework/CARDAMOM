...
int EDC2_1046(double const *pars, DATA DATA, struct EDCDIAGNOSTIC *EDCD)
{
...
Fout[S.C_lab]=FT[F.lab_release]+FT[F.d_lab]+FT[F.dx_lab2lit];
/*foliar*/
Fin[S.C_fol]=FT[F.fol_prod]+FT[F.lab_release];
Fout[S.C_fol]=FT[F.fol2lit]+FT[F.d_fol]+FT[F.dx_fol2lit];
/*root*/
Fin[S.C_roo]=FT[F.root_prod];
Fout[S.C_roo]=FT[F.roo2lit]+FT[F.d_roo]+FT[F.dx_roo2lit];
/*wood*/
Fin[S.C_woo]=FT[F.wood_prod];
Fout[S.C_woo]=FT[F.woo2som]+FT[F.d_woo]+FT[F.dx_woo2som];
/*litter*/
Fin[S.C_lit]=FT[F.fol2lit]+FT[F.roo2lit]+FT[F.dx_lab2lit]+FT[F.dx_fol2lit]+FT[F.dx_roo2lit];
Fout[S.C_lit]=FT[F.resp_het_lit]+FT[F.lit2som]+FT[F.d_lit]+FT[F.dx_lit2som];
/*som*/
Fin[S.C_som]=FT[F.woo2som]+FT[F.lit2som]+FT[F.dx_woo2som]+FT[F.dx_lit2som];
Fout[S.C_som]=FT[F.resp_het_som]+FT[F.d_som];
/*PAH2O*/
