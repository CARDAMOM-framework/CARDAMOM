...
int PARS_INFO_1200(DATA *CARDADATA)
{
...
/*Fossil fuel emissions (gC/m2/day)*/
CARDADATA->parmin[33]=0.001;
CARDADATA->parmax[33]=1000;

/*Fossil fuel trend (frac/day)*/
CARDADATA->parmin[34]=exp(-0.25);
CARDADATA->parmax[34]=exp(0.25);
