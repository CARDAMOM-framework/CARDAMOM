#pragma once
#include "PARS_INFO_1200.c"
#include "DALEC_1200.c"
#include "EDC1_1200.c"
#include "EDC2_1200.c"
...
int MODEL_INFO_1200(DATA * DATA){
/*Branched from ID=805 on Jun 15 2018*/
/*Difference = include fossil fuel mean & trend parameters*/
...
DALECmodel.nopars=33+2;
DALECmodel.nofluxes=30+1;
...
DALECmodel.dalec=DALEC_1200;
DALECmodel.edc1=EDC1_1200;
DALECmodel.edc2=EDC2_1200;
